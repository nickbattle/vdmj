...
public class DOCTraceDefinitionTermList extends DOCMappedList<TCTraceDefinitionTerm, DOCTraceDefinitionTerm>
{
	private static final long serialVersionUID = 1L;

	public DOCTraceDefinitionTermList(TCTraceDefinitionTermList list) throws Exception
	{
		super(list);
	}
