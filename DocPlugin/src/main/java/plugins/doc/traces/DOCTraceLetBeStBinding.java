...
public class DOCTraceLetBeStBinding extends DOCTraceDefinition
{
	private final DOCMultipleBind bind;
	private final DOCExpression stexp;
	private final DOCTraceDefinition body;

	public DOCTraceLetBeStBinding(LexLocation location, DOCMultipleBind bind, DOCExpression stexp, DOCTraceDefinition body)
	{
		super(location);
		this.bind = bind;
		this.stexp = stexp;
