...
public class DOCTraceDefinitionList extends DOCMappedList<TCTraceDefinition, DOCTraceDefinition>
{
	private static final long serialVersionUID = 1L;

	public DOCTraceDefinitionList(TCTraceDefinitionList list) throws Exception
	{
		super(list);
	}
