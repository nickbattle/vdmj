...
public class DOCTraceDefinitionTerm extends DOCMappedList<TCTraceDefinition, DOCTraceDefinition>
{
	private static final long serialVersionUID = 1L;

	public DOCTraceDefinitionTerm(TCTraceDefinitionTerm list) throws Exception
	{
		super(list);
	}
