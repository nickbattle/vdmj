...
public class DOCTraceApplyExpression extends DOCTraceCoreDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCStatement callStatement;

	public DOCTraceApplyExpression(DOCStatement callStatement)
	{
