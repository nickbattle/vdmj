...
import plugins.doc.modules.DOCImportedValue;
import plugins.doc.types.DOCType;

public class DOCImportedFunction extends DOCImportedValue
{
	private final DOCNameList typeParams;

	public DOCImportedFunction(DOCNameToken name, DOCType type, DOCNameList typeParams, DOCNameToken renamed)
	{
