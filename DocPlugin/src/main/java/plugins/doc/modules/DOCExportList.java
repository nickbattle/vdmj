...
import com.fujitsu.vdmj.tc.modules.TCExportList;

public class DOCExportList extends DOCMappedList<TCExport, DOCExport>
{
	private static final long serialVersionUID = 1L;

	public DOCExportList(TCExportList list) throws Exception
	{
		super(list);
	}
