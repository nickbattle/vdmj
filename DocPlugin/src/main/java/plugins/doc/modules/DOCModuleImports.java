...
import plugins.doc.modules.DOCImportFromModuleList;

public class DOCModuleImports extends DOCNode
{
	private final DOCIdentifierToken name;
	private final DOCImportFromModuleList imports;

	public DOCModuleImports(DOCIdentifierToken name, DOCImportFromModuleList imports)
	{
		super();
		this.name = name;
