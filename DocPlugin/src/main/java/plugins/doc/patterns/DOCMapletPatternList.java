...
public class DOCMapletPatternList extends DOCMappedList<TCMapletPattern, DOCMapletPattern>
{
	private static final long serialVersionUID = 1L;

	public DOCMapletPatternList(TCMapletPatternList list) throws Exception
	{
		super(list);
	}
