...
public class DOCMapletPattern extends DOCNode
{
	private final DOCPattern from;
	private final DOCPattern to;

	public DOCMapletPattern(DOCPattern from, DOCPattern to)
	{
		super();
		this.from = from;
		this.to = to;
