...
public class DOCMultipleSeqBind extends DOCMultipleBind
{
	private static final long serialVersionUID = 1L;
	private final DOCExpression sequence;

	public DOCMultipleSeqBind(DOCPatternList plist, DOCExpression sequence)
	{
		super(plist);
