...
public class DOCMultipleBindList extends DOCMappedList<TCMultipleBind, DOCMultipleBind>
{
	private static final long serialVersionUID = 1L;

	public DOCMultipleBindList(TCMultipleBindList list) throws Exception
	{
		super(list);
	}
