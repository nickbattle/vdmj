...
public class DOCDurationStatement extends DOCStatement
{
	private final DOCExpression duration;
	private final DOCStatement statement;

	public DOCDurationStatement(LexLocation location, DOCExpression duration, DOCStatement statement)
	{
		super(location);
