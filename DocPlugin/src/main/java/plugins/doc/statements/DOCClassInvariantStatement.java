...
public class DOCClassInvariantStatement extends DOCStatement
{
	private static final long serialVersionUID = 1L;
	private final DOCNameToken name;
	private final DOCDefinitionList invdefs;

	public DOCClassInvariantStatement(DOCNameToken name, DOCDefinitionList invdefs)
	{
		super(name.location);
		this.name = name;
