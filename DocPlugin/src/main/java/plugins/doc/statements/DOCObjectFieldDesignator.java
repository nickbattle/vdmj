...
public class DOCObjectFieldDesignator extends DOCObjectDesignator
{
	private final DOCObjectDesignator object;
	private final DOCNameToken classname;
	private final DOCIdentifierToken fieldname;

	public DOCObjectFieldDesignator(DOCObjectDesignator object, DOCNameToken classname, DOCIdentifierToken fieldname)
	{
