...
public class DOCCaseStmtAlternativeList extends DOCMappedList<TCCaseStmtAlternative, DOCCaseStmtAlternative>
{
	private static final long serialVersionUID = 1L;

	public DOCCaseStmtAlternativeList(TCCaseStmtAlternativeList list) throws Exception
	{
		super(list);
	}
