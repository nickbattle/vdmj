...
public class DOCTixeStmtAlternativeList extends DOCMappedList<TCTixeStmtAlternative, DOCTixeStmtAlternative>
{
	private static final long serialVersionUID = 1L;

	public DOCTixeStmtAlternativeList(TCTixeStmtAlternativeList list) throws Exception
	{
		super(list);
	}
