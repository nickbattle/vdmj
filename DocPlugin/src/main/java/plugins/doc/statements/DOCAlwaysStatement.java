...
public class DOCAlwaysStatement extends DOCStatement
{
	private final DOCStatement always;
	private final DOCStatement body;

	public DOCAlwaysStatement(LexLocation location, DOCStatement always, DOCStatement body)
	{
		super(location);
		this.always = always;
		this.body = body;
