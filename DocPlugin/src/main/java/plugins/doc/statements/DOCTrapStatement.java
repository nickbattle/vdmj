...
public class DOCTrapStatement extends DOCStatement
{
	private final DOCPatternBind patternBind;
	private final DOCStatement with;
	private final DOCStatement body;

	public DOCTrapStatement(LexLocation location, DOCPatternBind patternBind, DOCStatement with, DOCStatement body)
	{
		super(location);
