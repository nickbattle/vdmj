...
public class DOCAssignmentStatementList extends DOCMappedList<TCAssignmentStatement, DOCAssignmentStatement>
{
	private static final long serialVersionUID = 1L;

	public DOCAssignmentStatementList(TCAssignmentStatementList list) throws Exception
	{
		super(list);
	}
