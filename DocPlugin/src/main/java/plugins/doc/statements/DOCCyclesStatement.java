...
public class DOCCyclesStatement extends DOCStatement
{
	private final DOCExpression cycles;
	private final DOCStatement statement;

	public DOCCyclesStatement(LexLocation location, DOCExpression cycles, DOCStatement statement)
	{
		super(location);
		this.cycles = cycles;
