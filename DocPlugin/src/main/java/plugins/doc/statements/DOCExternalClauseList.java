...
public class DOCExternalClauseList extends DOCMappedList<TCExternalClause, DOCExternalClause>
{
	private static final long serialVersionUID = 1L;

	public DOCExternalClauseList(TCExternalClauseList list) throws Exception
	{
		super(list);
	}
