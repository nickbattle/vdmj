...
import plugins.doc.statements.DOCStateDesignator;
import plugins.doc.statements.DOCStatement;

import com.fujitsu.vdmj.lex.LexLocation;

public class DOCAssignmentStatement extends DOCStatement
{
	private final DOCStateDesignator target;
	private final DOCExpression exp;

	public DOCAssignmentStatement(LexLocation location, DOCStateDesignator target, DOCExpression exp)
	{
		super(location);
		this.target = target;
		this.exp = exp;
