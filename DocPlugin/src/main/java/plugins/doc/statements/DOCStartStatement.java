...
public class DOCStartStatement extends DOCStatement
{
	private final DOCExpression objects;

	public DOCStartStatement(LexLocation location, DOCExpression objects)
	{
		super(location);
