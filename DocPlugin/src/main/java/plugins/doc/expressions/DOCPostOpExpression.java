...
public class DOCPostOpExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final DOCNameToken opname;
	private final DOCExpression preexpression;
	private final DOCExpression postexpression;
	private final DOCErrorCaseList errors;
	private final DOCStateDefinition state;

	public DOCPostOpExpression(DOCNameToken opname, DOCExpression preexpression, DOCExpression postexpression, DOCErrorCaseList errors, DOCStateDefinition state)
	{
