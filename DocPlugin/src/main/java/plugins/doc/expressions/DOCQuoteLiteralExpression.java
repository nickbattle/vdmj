...
public class DOCQuoteLiteralExpression extends DOCExpression
{
	private final LexQuoteToken type;

	public DOCQuoteLiteralExpression(LexLocation location, LexQuoteToken type)
	{
		super(location);
		this.type = type;
	}
