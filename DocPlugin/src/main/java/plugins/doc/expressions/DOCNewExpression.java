...
public class DOCNewExpression extends DOCExpression
{
	private final DOCIdentifierToken classname;
	private final DOCExpressionList args;

	public DOCNewExpression(LexLocation location, DOCIdentifierToken classname, DOCExpressionList args)
	{
		super(location);
