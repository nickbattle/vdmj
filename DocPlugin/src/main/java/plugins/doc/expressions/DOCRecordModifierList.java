...
public class DOCRecordModifierList extends DOCMappedList<TCRecordModifier, DOCRecordModifier>
{
	private static final long serialVersionUID = 1L;

	public DOCRecordModifierList(TCRecordModifierList list) throws Exception
	{
		super(list);
	}
