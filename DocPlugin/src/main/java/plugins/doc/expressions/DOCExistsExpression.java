...
public class DOCExistsExpression extends DOCExpression
{
	private final DOCMultipleBindList bindList;
	private final DOCExpression predicate;

	public DOCExistsExpression(LexLocation location, DOCMultipleBindList bindList, DOCExpression predicate)
	{
		super(location);
