...
public class DOCMapletExpressionList extends DOCMappedList<TCMapletExpression, DOCMapletExpression>
{
	private static final long serialVersionUID = 1L;

	public DOCMapletExpressionList(TCMapletExpressionList list) throws Exception
	{
		super(list);
	}
