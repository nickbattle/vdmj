...
public class DOCCaseAlternative extends DOCNode
{
	private static final long serialVersionUID = 1L;
	private final DOCExpression cexp;
	private final DOCPattern pattern;
	private final DOCExpression result;

	public DOCCaseAlternative(DOCExpression cexp, DOCPattern pattern, DOCExpression result)
	{
		super();
		this.cexp = cexp;
