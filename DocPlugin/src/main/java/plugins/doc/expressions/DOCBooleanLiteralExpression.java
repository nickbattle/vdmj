...
public class DOCBooleanLiteralExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final LexBooleanToken value;

	public DOCBooleanLiteralExpression(LexBooleanToken value)
	{
