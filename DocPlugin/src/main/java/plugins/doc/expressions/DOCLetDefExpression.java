...
public class DOCLetDefExpression extends DOCExpression
{
	private final DOCDefinitionList localDefs;
	private final DOCExpression expression;

	public DOCLetDefExpression(LexLocation location, DOCDefinitionList localDefs, DOCExpression expression)
	{
		super(location);
