...
public class DOCHistoryExpression extends DOCExpression
{
	private final Token hop;
	private final DOCNameList opnames;

	public DOCHistoryExpression(LexLocation location, Token hop, DOCNameList opnames)
	{
		super(location);
		this.hop = hop;
