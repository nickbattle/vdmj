...
public class DOCIsExpression extends DOCExpression
{
	private final DOCNameToken typename;
	private final DOCType basictype;
	private final DOCExpression test;

	public DOCIsExpression(LexLocation location, DOCNameToken typename, DOCType basictype, DOCExpression test)
	{
		super(location);
