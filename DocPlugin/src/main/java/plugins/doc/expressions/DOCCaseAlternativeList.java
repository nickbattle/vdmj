...
public class DOCCaseAlternativeList extends DOCMappedList<TCCaseAlternative, DOCCaseAlternative>
{
	private static final long serialVersionUID = 1L;

	public DOCCaseAlternativeList(TCCaseAlternativeList list) throws Exception
	{
		super(list);
	}
