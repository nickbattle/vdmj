...
public class DOCFieldNumberExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final DOCExpression tuple;
	private final LexIntegerToken field;

	public DOCFieldNumberExpression(DOCExpression tuple, LexIntegerToken field)
	{
