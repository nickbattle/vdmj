...
public class DOCForAllExpression extends DOCExpression
{
	private final DOCMultipleBindList bindList;
	private final DOCExpression predicate;

	public DOCForAllExpression(LexLocation location, DOCMultipleBindList bindList, DOCExpression predicate)
	{
		super(location);
