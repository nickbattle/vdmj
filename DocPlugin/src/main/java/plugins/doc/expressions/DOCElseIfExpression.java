...
public class DOCElseIfExpression extends DOCExpression
{
	private final DOCExpression elseIfExp;
	private final DOCExpression thenExp;

	public DOCElseIfExpression(LexLocation location, DOCExpression elseIfExp, DOCExpression thenExp)
	{
		super(location);
