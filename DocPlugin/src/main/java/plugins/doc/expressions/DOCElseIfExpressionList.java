...
public class DOCElseIfExpressionList extends DOCMappedList<TCElseIfExpression, DOCElseIfExpression>
{
	private static final long serialVersionUID = 1L;

	public DOCElseIfExpressionList(TCElseIfExpressionList list) throws Exception
	{
		super(list);
	}
