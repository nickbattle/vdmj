...
abstract public class DOCUnaryExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	protected final DOCExpression exp;

	public DOCUnaryExpression(LexLocation location, DOCExpression exp)
	{
		super(location);
		this.exp = exp;
	}
