...
public class DOCIntegerLiteralExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final LexIntegerToken value;

	public DOCIntegerLiteralExpression(LexIntegerToken value)
	{
