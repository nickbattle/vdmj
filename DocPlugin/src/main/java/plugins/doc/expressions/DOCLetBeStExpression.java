...
public class DOCLetBeStExpression extends DOCExpression
{
	private final DOCMultipleBind bind;
	private final DOCExpression suchThat;
	private final DOCExpression value;

	public DOCLetBeStExpression(LexLocation location, DOCMultipleBind bind, DOCExpression suchThat, DOCExpression value)
	{
		super(location);
		this.bind = bind;
