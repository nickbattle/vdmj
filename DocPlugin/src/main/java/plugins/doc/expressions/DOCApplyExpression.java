...
public class DOCApplyExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final DOCExpression root;
	private final DOCExpressionList args;

	public DOCApplyExpression(DOCExpression root, DOCExpressionList args)
	{
		super(root.location);
		this.root = root;
		this.args = args;
