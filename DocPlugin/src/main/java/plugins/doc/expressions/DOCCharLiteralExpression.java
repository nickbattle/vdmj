...
public class DOCCharLiteralExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final LexCharacterToken value;

	public DOCCharLiteralExpression(LexCharacterToken value)
	{
