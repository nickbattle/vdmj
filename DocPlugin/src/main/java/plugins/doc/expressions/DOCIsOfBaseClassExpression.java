...
public class DOCIsOfBaseClassExpression extends DOCExpression
{
	private final DOCNameToken baseclass;
	private final DOCExpression exp;

	public DOCIsOfBaseClassExpression(LexLocation location, DOCNameToken baseclass, DOCExpression exp)
	{
		super(location);
