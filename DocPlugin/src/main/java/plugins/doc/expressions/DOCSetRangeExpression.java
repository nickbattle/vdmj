...
public class DOCSetRangeExpression extends DOCSetExpression
{
	private final DOCExpression first;
	private final DOCExpression last;

	public DOCSetRangeExpression(LexLocation location, DOCExpression first, DOCExpression last)
	{
		super(location);
		this.first = first;
		this.last = last;
