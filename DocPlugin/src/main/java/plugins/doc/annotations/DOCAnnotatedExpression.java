...
public class DOCAnnotatedExpression extends DOCExpression
{
	private static final long serialVersionUID = 1L;
	private final DOCAnnotation annotation;
	private final DOCExpression expression;

	public DOCAnnotatedExpression(LexLocation location, DOCAnnotation annotation, DOCExpression expression)
	{
		super(location);
