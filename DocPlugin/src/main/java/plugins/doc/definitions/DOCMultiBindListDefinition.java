...
public class DOCMultiBindListDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCMultipleBindList bindings;

	public DOCMultiBindListDefinition(LexLocation location, DOCMultipleBindList bindings)
	{
		super(location, DOCAccessSpecifier.DEFAULT, null);
