...
public class DOCInheritedDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCDefinition superdef;

	public DOCInheritedDefinition(DOCAccessSpecifier accessSpecifier, DOCNameToken name, DOCDefinition superdef)
	{
