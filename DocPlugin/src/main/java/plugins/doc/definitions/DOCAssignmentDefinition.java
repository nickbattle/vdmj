...
public class DOCAssignmentDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCType type;
	private final DOCExpression expression;

	public DOCAssignmentDefinition(DOCAccessSpecifier accessSpecifier, DOCNameToken name, DOCType type, DOCExpression expression)
	{
		super(name.location, null, accessSpecifier, name);
		this.type = type;
		this.expression = expression;
	}

	public DOCAssignmentDefinition(DOCAnnotationList annotations, DOCAccessSpecifier accessSpecifier, DOCNameToken name, DOCType type, DOCExpression expression)
	{
