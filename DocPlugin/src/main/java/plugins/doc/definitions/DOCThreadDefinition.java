...
public class DOCThreadDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCStatement statement;

	public DOCThreadDefinition(DOCStatement statement)
	{
		super(statement.location, DOCAccessSpecifier.DEFAULT, null);
