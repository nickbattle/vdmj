...
public class DOCRenamedDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCDefinition def;

	public DOCRenamedDefinition(DOCNameToken name, DOCDefinition def)
	{
		super(name.location, def.accessSpecifier, name);
		this.def = def;
	}
