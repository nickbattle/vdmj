...
public class DOCMutexSyncDefinition extends DOCDefinition
{
	private static final long serialVersionUID = 1L;
	private final DOCNameList operations;

	public DOCMutexSyncDefinition(DOCAnnotationList annotations, LexLocation location, DOCNameList operations)
	{
		super(location, annotations, null, null);
