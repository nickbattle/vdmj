...
public abstract class Expression implements Serializable
{
	...
	public abstract Type typeCheck(Environment env, TypeList qualifiers, NameScope scope, Type constraint);
	...
	protected Type checkConstraint(Type constraint, Type actual)
	{
		if (constraint != null)
		{
	...
	protected Type possibleConstraint(Type constraint, Type actual)
	{
		if (constraint != null)
		{
