...
public class MapletExpression implements Serializable
{
	...
	public Type typeCheck(Environment env, NameScope scope, Type domConstraint, Type rngConstraint)
	{
		Type ltype = left.typeCheck(env, null, scope, domConstraint);
		Type rtype = right.typeCheck(env, null, scope, rngConstraint);
