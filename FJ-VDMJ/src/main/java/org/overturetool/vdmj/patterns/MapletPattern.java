...
public class MapletPattern implements Serializable
{
	...
	public boolean isConstrained()
	{
		...
		return (from.getPossibleType().isUnion(from.location) || to.getPossibleType().isUnion(to.location));
	}
	...
	{
		return new MapType(from.location, from.getPossibleType(), to.getPossibleType());
	}
}
