...
public class ClassDefinition extends Definition
{
		...
		LexNameList supernames, DefinitionList definitions)
	{
		...
		this.setAccessSpecifier(new AccessSpecifier(false, false, Token.PUBLIC, false));
		...
		throws ValueException
	{
		...
		return makeNewInstance(
			ctorDefinition, argvals, ctxt, new HashMap<LexNameToken, ObjectValue>(), false);
	}
	...
	protected ObjectValue makeNewInstance(
		...
		Context ctxt, Map<LexNameToken, ObjectValue> done, boolean nested)
		throws ValueException
	{
		...
		if (ctorDefinition == null)
		{
			...
			ctorDefinition = findConstructor(new TypeList());
		...
		if (ctor != null)	// Class may have no constructor defined
		{
    		...
    		ObjectContext ctorCtxt = new ObjectContext(
    				ov.name.location, name.name + " constructor", ctxt, object);
