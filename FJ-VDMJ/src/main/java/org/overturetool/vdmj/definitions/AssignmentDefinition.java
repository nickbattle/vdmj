...
public class AssignmentDefinition extends Definition
{
	...
	public AssignmentDefinition(LexNameToken name, Type type, Expression expression, NameScope scope)
	{
		super(Pass.VALUES, name.location, name, scope);
		this.type = type;
	...
	{
		this(name, type, expression, NameScope.STATE);
	}
