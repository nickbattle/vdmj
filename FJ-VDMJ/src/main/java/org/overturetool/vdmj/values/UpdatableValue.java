...
public class UpdatableValue extends ReferenceValue
{
	...
	public static UpdatableValue factory(Value value, ValueListenerList listeners, Type type)
	{
	...
	public static UpdatableValue factory(ValueListenerList listeners, Type type)
	{
		if (Settings.dialect == Dialect.VDM_RT &&
			Properties.rt_duration_transactions)
		{
	...
	protected UpdatableValue(Value value, ValueListenerList listeners, Type type)
	{
		super(value);
	...
	protected UpdatableValue(ValueListenerList listeners, Type type)
	{
		super();
		this.listeners = listeners;
		this.restrictedTo = type;
	...
	@Override
	protected
	synchronized Value convertValueTo(Type to, Context ctxt, TypeSet done) throws ValueException
	{
