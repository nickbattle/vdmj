...
public class PogTest extends TestCase
{
	...
	private String[] expectedLoops =
	{
		...
		/* 18 */ "(forall size:nat &\n  (let ax : nat = 0 in\n    (let z : nat = (hd [0, 1, 2, 3]) in\n      (let DONE_60$ : seq of nat = [z] in\n        (ax = sumq(DONE_60$))))))\n",
		/* 19 */ "(forall size:nat &\n  (let ax : nat = 0 in\n    (forall ax:nat, z:nat, DONE_60$:seq of nat &\n      (((DONE_60$ = ([0, 1, 2, 3](1, ..., (len DONE_60$)))) and (z in set (elems (([0, 1, 2, 3](((len DONE_60$) + 1), ..., (len [0, 1, 2, 3]))))))) and (ax = sumq(DONE_60$)) =>\n        (let DONE_60$ : seq of nat = (DONE_60$ ^ [z]) in\n          (let ax : nat = (ax + z) in\n            (ax = sumq(DONE_60$))))))))\n",
