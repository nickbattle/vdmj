...
public class PogTest extends TestCase
{
	...
	private String[] expectedLoops =
	{
		...
		/* 14 */ "(forall size:nat &\n  (let ax : nat = 0 in\n    (({1, 2, 3} <> {}) =>\n      (forall z in set {1, 2, 3} &\n        (let ABC : set of nat1 = {z} in\n          (ax = sums(ABC)))))))\n",
		...
		/* 20 */ "(forall size:nat &\n  (let ax : nat = 0 in\n    (([0, 1, 2, 3] <> []) =>\n      (let DONE_60$ : seq of nat = [(hd [0, 1, 2, 3])] in\n        (ax = sumq(DONE_60$))))))\n",
		/* 21 */ "(forall size:nat &\n  (let ax : nat = 0 in\n    (([0, 1, 2, 3] <> []) =>\n      (forall ax:nat, z:nat, DONE_60$:seq of nat &\n        (((DONE_60$ ^ [(hd [0, 1, 2, 3])]) = ([0, 1, 2, 3](1, ..., ((len DONE_60$) + 1)))) and (ax = sumq(DONE_60$)) =>\n          (let DONE_60$ : seq of nat = (DONE_60$ ^ [z]) in\n            (let ax : nat = (ax + z) in\n              (ax = sumq(DONE_60$)))))))))\n",
