...
public enum POType
{
	...
	FUNC_POST_CONDITION("postcondition"),
	...
	FUNC_RECURSIVE("recursive function"),
	OP_RECURSIVE("recursive operation"),
	STATE_INVARIANT("state invariant"),
	LOOP_INVARIANT("loop invariant"),
	LOOP_MEASURE("loop measure"),
	OP_PRE_CONDITION("operation precondition"),
	OP_POST_CONDITION("operation postcondition"),
