...
public class SubTypeObligation extends ProofObligation
{
	 ...
	 */
	public static ProofObligationList getAllPOs(
			POExpression exp, TCType etype, TCType atype, POContextStack ctxt)
	{
	...
	public static ProofObligationList getAllPOs(LexLocation call, PODefinition opdef, TCType atype, POContextStack ctxt)
	{
		ProofObligationList results = new ProofObligationList();
