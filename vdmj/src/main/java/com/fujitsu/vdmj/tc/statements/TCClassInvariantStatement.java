...
public class TCClassInvariantStatement extends TCStatement
{
	private static final long serialVersionUID = 1L;
	public final TCNameToken name;
	public final TCDefinitionList invdefs;

	public TCClassInvariantStatement(TCNameToken name, TCDefinitionList invdefs)
	{
