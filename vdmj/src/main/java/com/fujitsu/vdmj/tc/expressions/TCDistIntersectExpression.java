...
public class TCDistIntersectExpression extends TCUnaryExpression
{
	private static final long serialVersionUID = 1L;

	public TCDistIntersectExpression(LexLocation location, TCExpression exp)
	{
		super(location, exp);
	}
	...
	{
		TCType arg = exp.typeCheck(env, null, scope, null);
