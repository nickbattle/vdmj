...
public class INSetCompExpression extends INSetExpression
{
	...
	public INSetCompExpression(LexLocation start,
		INExpression first, INMultipleBindList bindings, INExpression predicate)
	{
		super(start);
		this.first = first;
