...
public class ASTIsOfBaseClassExpression extends ASTExpression
{
	private static final long serialVersionUID = 1L;
	public final LexNameToken baseclass;
	public final ASTExpression exp;

	public ASTIsOfBaseClassExpression(
		LexLocation start, LexNameToken classname, ASTExpression exp)
	{
		super(start);
