...
public class ASTSetCompExpression extends ASTSetExpression
{
	...
	public ASTSetCompExpression(LexLocation start,
		ASTExpression first, ASTMultipleBindList bindings, ASTExpression predicate)
	{
		super(start);
		this.first = first;
