 ...
 */
public class ASTInheritedDefinition extends ASTDefinition
{
	private static final long serialVersionUID = 1L;
	public final ASTDefinition superdef;

	public ASTInheritedDefinition(LexNameToken localname, ASTDefinition def)
	{
