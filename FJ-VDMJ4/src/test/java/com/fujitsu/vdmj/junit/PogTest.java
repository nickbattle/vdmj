...
public class PogTest extends TestCase
{
	...
	private String[] expected =
	{
		...
		"(forall u:U &\n  is_(u, (nat * nat)))\n",
		"(is_([1, 2, true], T1) and ((is_(1, bool))\nand (is_(2, bool)))) or\n(is_([1, 2, true], T2) and inv_T2([1, 2, true]) and ((is_nat1(true))))\n",
		"(forall t:(T1 | T2) &\n  (is_([1, 2, 3, true], T1) and ((is_(1, bool))\n  and (is_(2, bool))\n  and (is_(3, bool)))) or\n  (is_([1, 2, 3, true], T2) and inv_T2([1, 2, 3, true]) and ((is_nat1(true)))))\n",
