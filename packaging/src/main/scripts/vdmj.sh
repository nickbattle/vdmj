...
VERSION=${VDMJ_VERSION:-4.8.0-SNAPSHOT}
...
QUICKCHECK_JAR=$DIR/quickcheck-${VERSION}.jar
SMTLIB_JAR=$DIR/smtlib-${VERSION}.jar

CLASSPATH="$VDMJ_JAR:$ANNOTATIONS_JAR:$ANNOTATIONS2_JAR:$PLUGINS_JAR:$STDLIB_JAR:$QUICKCHECK_JAR:$SMTLIB_JAR"
MAIN="VDMJ"
